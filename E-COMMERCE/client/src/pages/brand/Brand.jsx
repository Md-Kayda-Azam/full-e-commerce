...
import CreateBrand from "../../components/Modals/BrandModals/CreateBrand";
import UpdateBrand from "../../components/Modals/BrandModals/UpdateBrand";
import {
  deleteAlert,
  messageToaster,
  selectionRowsDelete,
...
const Brand = () => {
  ...
  return (
    <>
      ...
      <CreateBrand show="brandModalPopup" />
      <UpdateBrand idEdit={idEdit} show="brandEditModalPopup" />
      <div className="row">
